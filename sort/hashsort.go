...
// Adapted from https://github.com/AlasdairF/Sort/tree/master/Int
// - no LICENSE, see https://github.com/AlasdairF/Sort/issues/1
// ================= COMMON =================
...
func medianOfThreeAsc(data []int, m1, m0, m2 int) {
...
func medianOfThreeDesc(data []int, m1, m0, m2 int) {
	// bubble sort on 3 elements
	if data[m1] > data[m0] {
		data[m1], data[m0] = data[m0], data[m1]
	}
